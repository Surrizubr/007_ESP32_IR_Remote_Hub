 ...
 *
 * Pinos configurados:
 *   GPIO ${pinConfig.irReceiverPin}  → Receptor IR  (TSOP38238 / VS1838B)
 *   GPIO ${pinConfig.irTransmitterPin}  → Emissor IR   (LED IR + Transistor)
 *   GPIO ${pinConfig.statusLedPin}  → LED de Status
 *   GPIO ${pinConfig.buzzerPin ?? 0}  → Buzzer (0 = desabilitado)
 * =========================================================================
 */
